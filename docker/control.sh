...
start)
	git pull
	# ./fixup.sh
	docker compose -p heisse-preise-de -f docker-compose.base.yml -f docker-compose.prod.yml build
	docker compose -p heisse-preise-de -f docker-compose.base.yml -f docker-compose.prod.yml up -d
	;;
startdev)
	docker compose -p heisse-preise-de -f docker-compose.base.yml -f docker-compose.dev.yml build
	docker compose -p heisse-preise-de -f docker-compose.base.yml -f docker-compose.dev.yml up
	;;
reloadnginx)
	...
	;;
stop)
	docker compose -p heisse-preise-de -f docker-compose.base.yml down -t 1
	;;
shell)
...
shellnginx)
	...
	;;
logs)
	docker compose -p heisse-preise-de -f docker-compose.base.yml logs -f
	;;
*)
