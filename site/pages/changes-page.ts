...
import { copyCurrentURLToClipboard, getQueryParam, setQueryParam } from "../utils/utils";

@customElement("hp-changes-page")
export class ChangesPage extends LitElement {
    ...
    protected render(): unknown {
        return html`
            <main>
                ...
                <h1 class="text-center text-2xl font-bold">${i18n("Price Changes")}</h1>
                ${!this.items
